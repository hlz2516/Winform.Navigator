...
namespace AutoSizeTools
{
    ...
    public class AutoSizeHelper
    {
        ...
        private Size formDesignedSize = default(Size);
        ...
        public void UpdateControls()
        {
            ...
            while (queue.Count > 0)
            {
                ...
                if (scaleMap.ContainsKey(curCtrl.Name))
                {
                    ...
                    //Console.WriteLine($"form name:{_container.Name}  form clientsize:{_container.ClientSize}");
                    //Console.WriteLine($"ctrl name:{curCtrl.Name}  curl loc:{curCtrl.Location}");
                }
            }
        ...
        /// The properties of the new child control must be the same as when added to the container in the form designer
        /// </summary>
        ...
        {
            return scaleMap.ContainsKey(control.Name);
        }
    }
}